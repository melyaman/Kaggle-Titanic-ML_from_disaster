...
###### We generate a feature indicating which family people are in ########
...
# Plot the scores to select the best Predictors
...
print("accuracy after ensembling Boosting and logistic Regression:")
print(accuracy)
...
submission.to_csv("titanic_predictions_2.csv", index=False)
